...
extern void gdImageLine(gdImagePtr, int, int, int, int, int);
/* For backwards compatibility only. Use gdImageSetStyle()
	for much more flexible line drawing. */
extern void gdImageDashedLine (gdImagePtr, int, int, int, int, int);
/* Corners specified (not width and height). Upper left first, lower right
 	second. */
extern void gdImageRectangle(gdImagePtr, int, int, int, int, int);
/* Solid bar. Upper left corner first, lower right corner second. */
extern void gdImageFilledRectangle(gdImagePtr, int, int, int, int, int);
extern int gdImageBoundsSafe(gdImagePtr im, int x, int y);
extern void gdImageChar(gdImagePtr, gdFontPtr, int, int, int, int);
extern void gdImageCharUp(gdImagePtr, gdFontPtr, int, int, int, int);
extern void gdImageString(gdImagePtr, gdFontPtr, int, int, unsigned char *, int);
