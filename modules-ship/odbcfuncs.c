...
static PFunDesc func_table[] =
{
  ...
  { "ODBC::DATABASE-EXEC-SQL",   	0, 0, pf_database_exec_sql },
  ...
  { "ODBC::PACKAGE-TO-TABLE",		0, 0, pf_package_to_table },
  { "ODBC::NUMBER-OF-ROWS",   	        0, 0, pf_database_num_rows },
  { "ODBC::AFFECTED-ROWS",   	        0, 0, pf_database_affected_rows },
  ...
  { "ODBC::DATABASE-TABLES-INFO",     	0, 0, pf_database_tables_info },
  { "ODBC::DATABASE-TABLE-INFO",     	0, 0, pf_database_tables_info },
  { "ODBC::DATABASE-COLUMNS",           0, 0, pf_database_columns },
  { "ODBC::DATABASE-COLUMN-INFO",       0, 0, pf_database_column_info },
  { "ODBC::DATABASE-COLUMNS-INFO",      0, 0, pf_database_columns_info },
  { "ODBC::DATABASE-QUERY-INFO",        0, 0, pf_database_query_info },
  ...
  { "ODBC::GET-INFO",                   0, 0, pf_odbc_get_info },
  { "ODBC::SET-CONNECT-OPTION",         0, 0, pf_odbc_set_connect_option },
  { "ODBC::GET-CONNECT-OPTION",         0, 0, pf_odbc_get_connect_option },
...
DEFVAR (odbc::odbc-error-message,
