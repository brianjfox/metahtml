...
{
#endif
extern char *xmalloc (int bytes), *xrealloc (char *p, int bytes);
...
extern void _rl_dispatch (int key, Keymap map);
...
int
rl_vi_overstrike_delete (int count, int ignore)
{
  int i, s;
