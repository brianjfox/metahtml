/* iodbcperfuncs.c:  ODBC database compatibility layer. */
...
/* iODBC compatibility layer */
/* iODBC includes from OpenLink Software drivers */
...
{
  { "iODBCPER::WITH-OPEN-DATABASE",	1, 0, pf_with_open_database },
  { "iODBCPER::DATABASE-EXEC-QUERY",	0, 0, pf_database_exec_query },
  { "iODBCPER::DATABASE-EXEC-SQL",	0, 0, pf_database_exec_sql },
  { "iODBCPER::DATABASE-NEXT-RECORD",	0, 0, pf_database_next_record },
  { "iODBCPER::DATABASE-SAVE-RECORD",	0, 0, pf_database_save_record },
  { "iODBCPER::DATABASE-DELETE-RECORD",	0, 0, pf_database_delete_record },
  { "iODBCPER::DATABASE-LOAD-RECORD",	0, 0, pf_database_load_record },
  { "iODBCPER::DATABASE-SAVE-PACKAGE",	0, 0, pf_database_save_package },
  { "iODBCPER::PACKAGE-TO-TABLE",	0, 0, pf_package_to_table },
  { "iODBCPER::NUMBER-OF-ROWS",		0, 0, pf_database_num_rows },
  { "iODBCPER::AFFECTED-ROWS",		0, 0, pf_database_affected_rows },
  { "iODBCPER::SET-ROW-POSITION",	0, 0, pf_database_set_pos },
  { "iODBCPER::DATABASE-QUERY",		0, 0, pf_database_query },
  { "iODBCPER::HOST-DATABASES",		0, 0, pf_host_databases },
  { "iODBCPER::DATABASE-TABLES",	0, 0, pf_database_tables },
  { "iODBCPER::DATABASE-TABLES-INFO",	0, 0, pf_database_tables_info },
  { "iODBCPER::DATABASE-TABLE-INFO",	0, 0, pf_database_tables_info },
  { "iODBCPER::DATABASE-COLUMNS",	0, 0, pf_database_columns },
  { "iODBCPER::DATABASE-COLUMN-INFO",	0, 0, pf_database_column_info },
  { "iODBCPER::DATABASE-COLUMNS-INFO",	0, 0, pf_database_columns_info },
  { "iODBCPER::DATABASE-QUERY-INFO",	0, 0, pf_database_query_info },
  { "iODBCPER::DATABASE-SET-OPTIONS",	0, 0, pf_database_set_options },
  { "iODBCPER::CURSOR-GET-COLUMN",	0, 0, pf_cursor_get_column },
  { "iODBCPER::QUERY-GET-COLUMN",	0, 0, pf_query_get_column },
  { "iODBCPER::SQL-TRANSACT",		0, 0, pf_sql_transact },
  { "iODBCPER::GET-INFO",		0, 0, pf_odbc_get_info },
  { "iODBCPER::SET-CONNECT-OPTION",	0, 0, pf_odbc_set_connect_option },
  { "iODBCPER::GET-CONNECT-OPTION",	0, 0, pf_odbc_get_connect_option },
...
DEFVAR (iodbcper::odbc-error-message,
