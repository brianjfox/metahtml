...
{
  { "iODBC::WITH-OPEN-DATABASE",	1, 0, pf_with_open_database },
  { "iODBC::DATABASE-EXEC-QUERY",	0, 0, pf_database_exec_query },
  { "iODBC::DATABASE-EXEC-SQL",   	0, 0, pf_database_exec_sql },
  { "iODBC::DATABASE-NEXT-RECORD",	0, 0, pf_database_next_record },
  { "iODBC::DATABASE-SAVE-RECORD",	0, 0, pf_database_save_record },
  { "iODBC::DATABASE-DELETE-RECORD",	0, 0, pf_database_delete_record },
  { "iODBC::DATABASE-LOAD-RECORD",	0, 0, pf_database_load_record },
  { "iODBC::DATABASE-SAVE-PACKAGE",	0, 0, pf_database_save_package },
  { "iODBC::PACKAGE-TO-TABLE",		0, 0, pf_package_to_table },
  { "iODBC::NUMBER-OF-ROWS",   	        0, 0, pf_database_num_rows },
  { "iODBC::AFFECTED-ROWS",   	        0, 0, pf_database_affected_rows },
  { "iODBC::SET-ROW-POSITION",		0, 0, pf_database_set_pos },
  { "iODBC::DATABASE-QUERY",		0, 0, pf_database_query },
  { "iODBC::HOST-DATABASES",	        0, 0, pf_host_databases },
  { "iODBC::DATABASE-TABLES",     	0, 0, pf_database_tables },
  { "iODBC::DATABASE-TABLES-INFO",     	0, 0, pf_database_tables_info },
  { "iODBC::DATABASE-TABLE-INFO",     	0, 0, pf_database_tables_info },
  { "iODBC::DATABASE-COLUMNS",          0, 0, pf_database_columns },
  { "iODBC::DATABASE-COLUMN-INFO",      0, 0, pf_database_column_info },
  { "iODBC::DATABASE-COLUMNS-INFO",     0, 0, pf_database_columns_info },
  { "iODBC::DATABASE-QUERY-INFO",       0, 0, pf_database_query_info },
  { "iODBC::DATABASE-SET-OPTIONS",      0, 0, pf_database_set_options },
  { "iODBC::CURSOR-GET-COLUMN",         0, 0, pf_cursor_get_column },
  { "iODBC::QUERY-GET-COLUMN",          0, 0, pf_query_get_column },
  { "iODBC::SQL-TRANSACT",              0, 0, pf_sql_transact },
  { "iODBC::GET-INFO",                  0, 0, pf_odbc_get_info },
  { "iODBC::SET-CONNECT-OPTION",        0, 0, pf_odbc_set_connect_option },
  { "iODBC::GET-CONNECT-OPTION",        0, 0, pf_odbc_get_connect_option },
  { (char *)NULL,			0, 0, (PFunHandler *)NULL }
};

PACKAGE_INITIALIZER (initialize_iodbc_functions)
DEFINE_SECTION (iODBC-DATABASE-EXTENSIONS, ODBC; database; records,
...
DEFVAR (iodbc::odbc-error-message,
