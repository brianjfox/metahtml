...
static SigHandler *old_alrm = (SigHandler *)NULL;
#if !defined (SHELL)
static SigHandler *old_tstp = (SigHandler *)NULL;
static SigHandler *old_ttou = (SigHandler *)NULL;
static SigHandler *old_ttin = (SigHandler *)NULL;
#endif /* !SHELL */
...
#if defined (HAVE_POSIX_SIGNALS)
static SigHandler *
rl_set_sighandler (int sig, SigHandler *handler)
{
  struct sigaction act, oact;

#if defined (_GNUC_) || defined (__cplusplus)
  act.sa_handler = (typeof (act.sa_handler))handler;
#else
  ...
  return ((SigHandler *)oact.sa_handler);
}
